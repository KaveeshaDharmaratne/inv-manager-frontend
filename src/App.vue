...
<template>
  <div>
    ...
    <div v-else
      ...
      <div v-if="isSidebarOpen" class="fixed inset-0 z-30 bg-zinc-950/40 md:hidden" aria-hidden="true"
        @click="closeSidebar" />
      ...
      <div class="flex min-w-0 flex-1 flex-col">
        <header
          ...
          <button type="button"
            ...
            aria-label="Toggle sidebar" aria-controls="app-sidebar" :aria-expanded="isSidebarOpen ? 'true' : 'false'"
            @click="toggleSidebar">
